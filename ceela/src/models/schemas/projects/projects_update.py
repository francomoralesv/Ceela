...
class ProjectUpdate(ProjectBase):
    ...
    latitude: float
    longitude: float
    building_name: str | None = None  # Optional building name field
...
class ProjectStatus(SQLModel):
    ...
    def validate_status(cls, v):
        v = v.lower()
        if v != "registrado" and v != "en proceso" and v != "finalizado":
            raise ValueError("El estado debe ser: Registrado, En proceso o Finalizado")
        return v
